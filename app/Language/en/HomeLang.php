...
return [
    'newsletterText' => '<strong class="c-darkgold d-block">TRADE</strong>
        <p class="c-darkgold fs-3">ลงทะเบียนเพื่อรับข่าวสาร</p>',
    
    'signupText' => '<strong class="c-darkgold d-block">MEMBER</strong>
