    ...
    <div class="app-content pt-3 p-md-3 p-lg-4">
        <div class="container-xl">
            ...
            <div class="row g-3 mb-4 align-items-center justify-content-between">
                <div class="col-auto">
                    <h1 class="app-page-title mb-0">บัญชีผู้ดูแล</h1>
                </div>
                <div class="col-auto">
                    <div class="page-utilities">
                        <div class="row g-2 justify-content-start justify-content-md-end align-items-center">                                                        
                            <div class="col-auto">						    
                                <a class="btn btn-success text-white" href="<?= site_url('admin/account/form') ?>">
                                    เพิ่มบัญชี
                                </a>
                            </div>
                        </div><!--//row-->
                    ...
                    <div class="table-responsive">
                        <table class="table app-table-hover mb-0 text-left">
                            ...
                            <tbody>
                                ...
                                ?>
                                    <tr>
                                        <td class="cell"><span class="truncate"><?= $row['account'] ?></span></td>
                                        ...
                                        <td class="cell text-center">
                                            <a class="btn-sm btn-warning" href="<?= site_url('admin/account/edit?id='.$row['id']) ?>">แก้ไข</a>
